...
- Pyproject.toml and build modernisation. ([#1156](https://github.com/pywr/pywr/issues/1156))
- Use Python 3.11 for cibuildwheel jobs. ([#1159](https://github.com/pywr/pywr/issues/1159))
- Upgrade GLPK to v5.0 on Windows and Linux. ([#1160](https://github.com/pywr/pywr/issues/1160))
