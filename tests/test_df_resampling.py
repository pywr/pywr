...
class TestUpSampling:
    """Test for up-sampling a dataframe to lower frequency model time-step."""
    def test_daily_to_monthly(self):
        ...
        pd.testing.assert_frame_equal(input_resampled, input_resampled.resample('M').mean())
    ...
    def test_daily_to_weekly(self):
        ...
        pd.testing.assert_index_equal(input_resampled.index, model_index)
        pd.testing.assert_frame_equal(input_resampled, input_resampled.resample('W').mean())

    def test_daily_to_7daily(self):
        ...
        pd.testing.assert_index_equal(input_resampled.index, model_index)
        pd.testing.assert_frame_equal(input_resampled, input_resampled.resample('7D').mean())

    def test_misaligned_daily_to_7daily(self):
        """Test daily to 7-day model time-step."""
    ...
    def test_weekly_to_two_weekly(self):
        """Test weekly to two-weekly model time-step."""
        input_df = make_df('W')
        model_index = make_model_index('2W')

        input_resampled = align_and_resample_dataframe(input_df, model_index, resample_func='mean')

        pd.testing.assert_index_equal(input_resampled.index, model_index)
        pd.testing.assert_frame_equal(input_resampled, input_resampled.resample('2W').mean())


class TestDownSampling:
    """Test for down-sampling a dataframe to higher frequency model time-step."""
    def test_monthly_to_daily(self):
        ...
        pd.testing.assert_index_equal(input_resampled.index, model_index)
        pd.testing.assert_frame_equal(input_resampled, input_resampled.resample('D').mean())
    ...
    def test_weekly_to_7daily(self):
    ...
    def test_nonaligned_weekly_to_7daily(self):
        ...
        expected_df = expected_df.resample('7D').mean()
    ...
    def test_two_weekly_to_weekly(self):
        ...
        pd.testing.assert_index_equal(input_resampled.index, model_index)
        pd.testing.assert_frame_equal(input_resampled, input_resampled.resample('W').ffill())
